...
13. If you are using WebStorm, right click somewhere over eslint.config.mjs, choose 'Apply ESlint Code Style Rules'. Enable format on save on [WebStorm](https://www.jetbrains.com/help/webstorm/es[...]
14. Write index.html:
    ```html
    <!DOCTYPE html>
    <html lang="en">
